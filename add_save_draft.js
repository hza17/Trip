...
content = content.replace(/<button \n\s*onClick=\{onBack\}\n\s*className="px-4 py-2 rounded-xl bg-white dark:bg-slate-950 border border-slate-200\/80 dark:border-white\/5 text-xss font-bold text-slate-600 dark:text-slate-300 hover:bg-slate-50 dark:hover:bg-slate-900 transition-all flex items-center gap-2 shadow-sm cursor-pointer"\n\s*>\n\s*<ArrowRight size=\{14\} \/>\n\s*<span>بازگشت به صفحه اصلی<\/span>\n\s*<\/button>/g, buttons);
